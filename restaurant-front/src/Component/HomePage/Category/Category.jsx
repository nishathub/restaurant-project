...
const Category = () => {
  return (
    <div className="pb-12 bg-red-700">
      <div className="marquee-container mb-6 lg:mb-12">
        <p className="marquee capitalize lg:text-2xl text-gray-200">
        <span className="text-4xl lg:text-6xl">🛵</span> Free delivery everyday Gulshan : 0150 111 8888 (12pm - 1am), Uttara :
      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row flex-wrap gap-12 lg:gap-20 justify-center items-center">
        ...
        <Link to={"/"} className="">
          <img className="w-20 lg:w-32 lg:mb-4" src={burger} alt="soup-photo" />
          <h6 className="text-center text-lg lg:text-2xl text-gray-200 font-bold">
            BURGER
          </h6>
        </Link>
        ...
        <Link to={"/"} className="">
          <img className="w-20 lg:w-32 lg:mb-4" src={salad} alt="soup-photo" />
          <h6 className="text-center text-lg lg:text-2xl text-gray-200 font-bold">
            SALAD
          </h6>
        </Link>
