...
const FoodItemCard = ({ item }) => {
  ...
  const { user, setAddCartLoading, customAlert, restaurantAPI } =
    ...
    <div className="w-96 rounded-md overflow-hidden hover:shadow-xl duration-300">
      ...
      <div className="h-60 p-8 flex flex-col gap-2 items-center justify-center lg:gap-4 text-center bg-[#f3f0f3] text-gray-800">
        ...
        <button
          ...
          className="p-4 hover:bg-red-700 border-b-4 border-red-700 rounded-md duration-300 cinzel-regular text-gray-800 hover:text-gray-100"
        >
          Add to cart
        </button>
      </div>
